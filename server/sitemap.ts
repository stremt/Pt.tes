...
const URLS: SitemapUrl[] = [
  ...
  { loc: "/tools/csv-viewer/edit-without-excel", priority: 0.75, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/csv-viewer/view-in-browser", priority: 0.75, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/csv-viewer/view-large-files", priority: 0.75, changefreq: "weekly", lastmod: TODAY },
  ...
  { loc: "/tools/convert-text-to-pdf-without-signup", priority: 0.8, changefreq: "monthly", lastmod: TODAY },
  ...
  { loc: "/tools/signature-tools", priority: 0.9, changefreq: "monthly", lastmod: TODAY },
  { loc: "/tools/signature-font-generator", priority: 0.9, changefreq: "monthly", lastmod: TODAY },
  { loc: "/tools/signature-for-tally", priority: 0.9, changefreq: "monthly", lastmod: TODAY },
  { loc: "/tools/email-signature-generator", priority: 0.9, changefreq: "monthly", lastmod: TODAY },
  ...
  // Signature tool — full longtail set (previously missing)
  { loc: "/tools/online-signature-generator", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/free-signature-generator", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/free-signature-generator-no-login", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/online-signature-generator-without-upload", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/digital-signature-generator", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/create-digital-signature", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-maker", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-maker-free", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/simple-signature-generator", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/simple-signature-maker-online-free", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/private-signature-generator", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/best-signature-generator-free", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/create-signature-online", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/esignature-maker", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/handwritten-signature-generator", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-creator", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/add-signature-to-pdf", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-for-pdf", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/mobile-signature-generator", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/gst-invoice-signature", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-for-gst-invoice", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/email-signature-maker", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/transparent-signature-png", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-for-contracts", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-for-aadhaar", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-for-word", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-for-google-docs", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/how-to-create-digital-signature", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/how-to-create-digital-signature-online", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/indian-digital-signature", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/signature-generator-india", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/how-to-add-signature-in-word", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/how-to-add-signature-in-gmail", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/free-signature-for-documents", priority: 0.75, changefreq: "monthly", lastmod: TODAY },

  // Video to MP3 — full longtail set (previously missing)
  { loc: "/tools/video-to-mp3-converter", priority: 0.9, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/free-video-to-mp3-converter", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/best-video-to-mp3-converter", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/online-video-to-mp3-converter", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/video-to-mp3-converter-free", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/browser-video-to-mp3-converter", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/convert-video-to-mp3-without-upload", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/offline-video-to-mp3-converter", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/private-video-to-mp3-converter", priority: 0.75, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/batch-video-to-mp3-converter", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/avi-to-mp3", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/mov-to-mp3", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/mkv-to-mp3", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/webm-to-mp3", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/extract-audio-from-video", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/convert-video-to-audio", priority: 0.85, changefreq: "weekly", lastmod: TODAY },
  { loc: "/tools/get-audio-from-video", priority: 0.8, changefreq: "weekly", lastmod: TODAY },
