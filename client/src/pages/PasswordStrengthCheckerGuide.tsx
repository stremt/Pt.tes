        ...
        <article className="space-y-12 mt-8">
          ...
          <section className="pt-12 border-t space-y-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-8">
              ...
              <Link href="/password-brute-force-calculator" className="p-4 rounded-xl border bg-muted/30 hover:bg-muted/50 transition-colors text-sm font-bold">Brute Force Calculator</Link>
              <Link href="/unhackable-password-generator" className="p-4 rounded-xl border bg-muted/30 hover:bg-muted/50 transition-colors text-sm font-bold">Unhackable Password Generator</Link>
              <Link href="/private-password-generator" className="p-4 rounded-xl border bg-muted/30 hover:bg-muted/50 transition-colors text-sm font-bold">Private Password Generator</Link>
              <Link href="/offline-password-generator" className="p-4 rounded-xl border bg-muted/30 hover:bg-muted/50 transition-colors text-sm font-bold">Offline Password Generator</Link>
              <Link href="/military-grade-password-generator" className="p-4 rounded-xl border bg-muted/30 hover:bg-muted/50 transition-colors text-sm font-bold">Military Grade Generator</Link>
            </div>
          </section>
        </article>
      </div>
