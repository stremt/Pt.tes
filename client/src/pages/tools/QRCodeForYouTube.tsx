  ...
  return (
    <>
      <script type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"WebPage","name":"QR Code for YouTube – Free YouTube Channel QR Code Generator | Pixocraft","description":"Create a QR code for your YouTube channel instantly. Grow your subscriber count with a scannable YouTube QR code for print and offline marketing.","url":"https://tools.pixocraft.in/tools/qr-code-for-youtube","publisher":{"@type":"Organization","name":"Pixocraft Tools","url":"https://tools.pixocraft.in","logo":{"@type":"ImageObject","url":"https://tools.pixocraft.in/favicon.png"}},"inLanguage":"en-IN","isPartOf":{"@type":"WebSite","@id":"https://tools.pixocraft.in"}})}
      </script>
      <script type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"How to Create a QR Code for YouTube","description":"Follow these steps to generate a QR code that links to your YouTube channel or video.","step":[{"@type":"HowToStep","name":"Copy Your YouTube Channel or Video URL","text":"Navigate to your YouTube channel or video and copy the URL from the browser address bar."},{"@type":"HowToStep","name":"Enter the URL into the QR Generator","text":"Open the Pixocraft QR Code Generator and paste your YouTube URL into the input field."},{"@type":"HowToStep","name":"Customize Your QR Code","text":"Pick brand colors and optionally add the YouTube logo or your channel icon to the center of the QR code."},{"@type":"HowToStep","name":"Download and Promote","text":"Download your QR code and add it to merchandise, flyers, posters, or event materials to drive new subscribers offline."}]})}
      </script>
      <script type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://tools.pixocraft.in/"},{"@type":"ListItem","position":2,"name":"QR Code Generator","item":"https://tools.pixocraft.in/tools/qr-maker"},{"@type":"ListItem","position":3,"name":"QR Code for YouTube","item":"https://tools.pixocraft.in/tools/qr-code-for-youtube"}]})}
      </script>
      <script type="application/ld+json">
      ...
      <div className="min-h-screen bg-background">
        {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-sm text-muted-foreground pt-4 pb-2 max-w-4xl mx-auto px-4 md:px-8 flex-wrap">
            ...
            <span>›</span>
            <span className="text-foreground">QR Code for YouTube</span>
          </nav>
        {/* Hero */}
          ...
          <section className="space-y-6 border-t pt-12">
            ...
            >
              {[
                ...
                { href: "/tools/qr-code-for-flyers", title: "QR Code for Flyers", desc: "Embed QR codes in flyers for video engagement." },
                { href: "/tools/qr-code-for-product-marketing", title: "QR Code for Product Marketing", desc: "Link QR codes to product demo videos." },
              ].map((item) => (
