  ...
  return (
    <>
      <script type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"WebPage","name":"QR Code for SMS – Free SMS QR Code Generator | Pixocraft","description":"Create a QR code for SMS that opens a pre-filled text message. Generate SMS QR codes for marketing, customer support, and business communication.","url":"https://tools.pixocraft.in/tools/qr-code-for-sms","publisher":{"@type":"Organization","name":"Pixocraft Tools","url":"https://tools.pixocraft.in","logo":{"@type":"ImageObject","url":"https://tools.pixocraft.in/favicon.png"}},"inLanguage":"en-IN","isPartOf":{"@type":"WebSite","@id":"https://tools.pixocraft.in"}})}
      </script>
      <script type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"How to Create a QR Code for SMS","description":"Follow these steps to generate a QR code that opens a pre-filled SMS message when scanned.","step":[{"@type":"HowToStep","name":"Enter the Recipient Phone Number","text":"Type the phone number that will receive the SMS, including the country code."},{"@type":"HowToStep","name":"Add a Pre-filled Message","text":"Optionally enter a default message text that appears in the SMS compose window when the user scans the code."},{"@type":"HowToStep","name":"Generate the SMS QR Code","text":"Click Generate in the Pixocraft QR Code Generator to create the SMS QR code instantly."},{"@type":"HowToStep","name":"Download and Deploy","text":"Download the QR code and place it on marketing materials, product packaging, business cards, or in-store displays."}]})}
      </script>
      <script type="application/ld+json">
        {JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://tools.pixocraft.in/"},{"@type":"ListItem","position":2,"name":"QR Code Generator","item":"https://tools.pixocraft.in/tools/qr-maker"},{"@type":"ListItem","position":3,"name":"QR Code for SMS","item":"https://tools.pixocraft.in/tools/qr-code-for-sms"}]})}
      </script>
      <script type="application/ld+json">
      ...
      <div className="min-h-screen bg-background">
        {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-sm text-muted-foreground pt-4 pb-2 max-w-4xl mx-auto px-4 md:px-8 flex-wrap">
            ...
            <span>›</span>
            <span className="text-foreground">QR Code for SMS</span>
          </nav>
        {/* Hero Section */}
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 space-y-20 pb-20">
          ...
          <section id="qr-tool-section">
            ...
            <div className="bg-muted/30 border rounded-lg p-6">
              <QRMaker embedMode={true} defaultType="sms" />
            </div>
          </section>
