...
const generateBreadcrumbSchema = () => ({
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 5, name: "Get Audio From Video", item: "https://tools.pixocraft.in/tools/get-audio-from-video" },
  ],
});
      ...
      <div className="min-h-screen">
        ...
        <section className="container mx-auto px-4 max-w-6xl pb-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-2">
            Get Audio From Video —<br className="hidden md:block" /> Free Online Tool
          </h1>
