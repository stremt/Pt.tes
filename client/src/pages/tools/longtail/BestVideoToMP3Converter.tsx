...
const generateBreadcrumbSchema = () => ({
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 5, name: "Best Video to MP3 Converter", item: "https://tools.pixocraft.in/tools/best-video-to-mp3-converter" },
  ],
});
      ...
      <div className="min-h-screen">
        ...
        <section className="container mx-auto px-4 max-w-6xl pb-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-2">
            Best Video to MP3 Converter —<br className="hidden md:block" /> Fast &amp; Free Online Tool
          </h1>
