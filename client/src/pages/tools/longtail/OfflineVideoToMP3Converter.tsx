...
const generateBreadcrumbSchema = () => ({
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Offline Video to MP3 Converter", item: "https://tools.pixocraft.in/tools/offline-video-to-mp3-converter" },
  ],
});
      ...
      <div className="min-h-screen">
        ...
        <section className="container mx-auto px-4 max-w-6xl pb-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
            Offline Video to MP3 Converter —<br className="hidden sm:block" /> Convert Videos Without Internet
          </h1>
