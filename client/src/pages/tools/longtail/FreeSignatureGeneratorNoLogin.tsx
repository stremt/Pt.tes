        ...
        <div className="mb-3 sm:mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="hidden md:block text-sm text-muted-foreground">Create your signature instantly without login or signup. 100% free, private, and works offline.</p>
            </div>
          </div>
