              ...
              <Card>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <h3 className="text-xl font-semibold mb-2">Drop watermarked PDF here</h3>
                    <p className="text-muted-foreground mb-6">or click to browse from device</p>
                    <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
                      <div className="flex items-center gap-1.5">
                        <Shield className="h-4 w-4" />
                        <span>Private cleaning</span>
                      </div>
