      ...
      <div className="container mx-auto px-2 sm:px-4 max-w-7xl">
        ...
        <section className="mb-12 md:mb-20">
          <div className="text-center mb-8 md:mb-12 px-4">
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4">Our Mission</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                <CardTitle className="text-base sm:text-lg md:text-xl">Why We Started Pixocraft Tools</CardTitle>
              </CardHeader>
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                <CardTitle className="text-base sm:text-lg md:text-xl">What Drives Us Forward</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        <section className="mb-12 md:mb-20">
          <div className="text-center mb-8 md:mb-12 px-4">
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4">Our Core Values</h2>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
                  <Zap className="h-6 w-6 sm:h-7 sm:w-7 text-primary" />
                </div>
                <CardTitle className="text-base sm:text-lg md:text-xl">Speed First</CardTitle>
              </CardHeader>
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Privacy Focused</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Always Free</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Accessible</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">User-Centered</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Community Driven</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="mb-12 md:mb-20">
          <div className="text-center mb-8 md:mb-12 px-4">
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4">200+ Tools Across 10+ Categories</h2>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Privacy & Security Tools</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Text & Image Tools</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="hover-elevate transition-all duration-200">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-base sm:text-lg md:text-xl">Developer & Math Tools</CardTitle>
              </CardHeader>
              <CardContent className="text-sm sm:text-base">
                <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="max-w-4xl mx-auto text-center">
          <Card className="bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 hover-elevate transition-all duration-200">
            <CardContent className="py-12 px-8 space-y-6">
              <h2 className="text-3xl md:text-3xl lg:text-4xl font-bold">Let's Connect</h2>
