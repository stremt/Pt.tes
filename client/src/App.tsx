...
// Lazily loaded pages — converted from eager imports to reduce initial bundle size
const OnlineNotepad = lazy(() => import("@/pages/tools/longtail/text-to-file/OnlineNotepad"));
const PlainTextEditor = lazy(() => import("@/pages/tools/longtail/text-to-file/PlainTextEditor"));
const CreateTextFileOnline = lazy(() => import("@/pages/tools/longtail/text-to-file/CreateTextFileOnline"));
const CreateConfigFileOnline = lazy(() => import("@/pages/tools/longtail/text-to-file/CreateConfigFileOnline"));
const BrowserTextEditor = lazy(() => import("@/pages/tools/longtail/text-to-file/BrowserTextEditor"));
const PrivacyCategory = lazy(() => import("@/pages/PrivacyCategory"));
const TextCategory = lazy(() => import("@/pages/TextCategory"));
const ImageCategory = lazy(() => import("@/pages/ImageCategory"));
const PDFCategory = lazy(() => import("@/pages/PDFCategory"));
const MediaCategory = lazy(() => import("@/pages/MediaCategory"));
const DeveloperCategory = lazy(() => import("@/pages/DeveloperCategory"));
const MathCategory = lazy(() => import("@/pages/MathCategory"));
const RandomCategory = lazy(() => import("@/pages/RandomCategory"));
const ProductivityCategory = lazy(() => import("@/pages/ProductivityCategory"));
const ColorCategory = lazy(() => import("@/pages/ColorCategory"));
const AICategory = lazy(() => import("@/pages/AICategory"));
const TempMailFacebookSignup = lazy(() => import("@/pages/TempMailFacebookSignup"));
const TempMailInstagramVerification = lazy(() => import("@/pages/TempMailInstagramVerification"));
const TempMailOnlineShopping = lazy(() => import("@/pages/TempMailOnlineShopping"));
const TempMailTestingAccounts = lazy(() => import("@/pages/TempMailTestingAccounts"));
const PasswordGeneratorOnlineAccounts = lazy(() => import("@/pages/PasswordGeneratorOnlineAccounts"));
const PasswordGeneratorSecurity = lazy(() => import("@/pages/PasswordGeneratorSecurity"));
const PasswordGeneratorBusiness = lazy(() => import("@/pages/PasswordGeneratorBusiness"));
const PasswordGeneratorTesting = lazy(() => import("@/pages/PasswordGeneratorTesting"));
const PasswordStrengthCheckOnline = lazy(() => import("@/pages/PasswordStrengthCheckOnline"));
const PasswordSecurityChecker = lazy(() => import("@/pages/PasswordSecurityChecker"));
const IsMyPasswordStrong = lazy(() => import("@/pages/IsMyPasswordStrong"));
const PasswordStrengthValidation = lazy(() => import("@/pages/PasswordStrengthValidation"));
const PasswordEntropyExplained = lazy(() => import("@/pages/PasswordEntropyExplained"));
const CommonPasswordMistakes = lazy(() => import("@/pages/CommonPasswordMistakes"));
const HowToCreateStrongPassword = lazy(() => import("@/pages/HowToCreateStrongPassword"));
const StrongPasswordExamples = lazy(() => import("@/pages/StrongPasswordExamples"));
const PasswordStrengthCheckerGuide = lazy(() => import("@/pages/PasswordStrengthCheckerGuide"));
const HowPasswordsGetHacked = lazy(() => import("@/pages/HowPasswordsGetHacked"));
const SecureRandomPasswordGenerator = lazy(() => import("@/pages/SecureRandomPasswordGenerator"));
const StrongestPasswordGenerator = lazy(() => import("@/pages/StrongestPasswordGenerator"));
const RandomStringGeneratorApiKeys = lazy(() => import("@/pages/RandomStringGeneratorApiKeys"));
const RandomStringGeneratorOnline = lazy(() => import("@/pages/RandomStringGeneratorOnline"));
const SecureRandomStringGenerator = lazy(() => import("@/pages/SecureRandomStringGenerator"));
const RandomStringGeneratorTesting = lazy(() => import("@/pages/RandomStringGeneratorTesting"));
const TextEncryptPrivateMessages = lazy(() => import("@/pages/TextEncryptPrivateMessages"));
const TextEncryptionOnline = lazy(() => import("@/pages/TextEncryptionOnline"));
const SecureMessageEncryption = lazy(() => import("@/pages/SecureMessageEncryption"));
const TextEncryptionStorage = lazy(() => import("@/pages/TextEncryptionStorage"));
const RemoveExifPhotoPrivacy = lazy(() => import("@/pages/RemoveExifPhotoPrivacy"));
const RemoveExifOnline = lazy(() => import("@/pages/RemoveExifOnline"));
const RemoveExifBeforeSharing = lazy(() => import("@/pages/RemoveExifBeforeSharing"));
const RemoveExifSocialMedia = lazy(() => import("@/pages/RemoveExifSocialMedia"));
const WordCounterEssays = lazy(() => import("@/pages/WordCounterEssays"));
const WordCounterOnline = lazy(() => import("@/pages/WordCounterOnline"));
const WordCounterContentMarketing = lazy(() => import("@/pages/WordCounterContentMarketing"));
const WordCounterSocialMedia = lazy(() => import("@/pages/WordCounterSocialMedia"));
const CompressImagesWeb = lazy(() => import("@/pages/CompressImagesWeb"));
const CompressJpgImages = lazy(() => import("@/pages/CompressJpgImages"));
const ReduceImageFileSize = lazy(() => import("@/pages/ReduceImageFileSize"));
const CompressPhotosEmail = lazy(() => import("@/pages/CompressPhotosEmail"));
const ResizeImagesSocialMedia = lazy(() => import("@/pages/ResizeImagesSocialMedia"));
const ResizeImagesOnline = lazy(() => import("@/pages/ResizeImagesOnline"));
const BulkResizeImages = lazy(() => import("@/pages/BulkResizeImages"));
const ResizeImageDimensions = lazy(() => import("@/pages/ResizeImageDimensions"));
const ConvertPdfToImage = lazy(() => import("@/pages/ConvertPdfToImage"));
const ConvertPdfToImageOnline = lazy(() => import("@/pages/ConvertPdfToImageOnline"));
const ConvertPdfToJpg = lazy(() => import("@/pages/ConvertPdfToJpg"));
const ExtractImagesFromPdf = lazy(() => import("@/pages/ExtractImagesFromPdf"));
const ConvertImageToPdf = lazy(() => import("@/pages/ConvertImageToPdf"));
const ConvertImageToPdfOnline = lazy(() => import("@/pages/ConvertImageToPdfOnline"));
const ConvertJpgToPdf = lazy(() => import("@/pages/ConvertJpgToPdf"));
const CombineImagesToPdf = lazy(() => import("@/pages/CombineImagesToPdf"));
const ConvertJpgToPng = lazy(() => import("@/pages/ConvertJpgToPng"));
const ConvertJpgToPngOnline = lazy(() => import("@/pages/ConvertJpgToPngOnline"));
const ConvertJpgToPngTransparent = lazy(() => import("@/pages/ConvertJpgToPngTransparent"));
const BatchConvertJpgToPng = lazy(() => import("@/pages/BatchConvertJpgToPng"));
const ConvertPngToJpg = lazy(() => import("@/pages/ConvertPngToJpg"));
const ConvertPngToJpgOnline = lazy(() => import("@/pages/ConvertPngToJpgOnline"));
const ConvertPngToJpgHighQuality = lazy(() => import("@/pages/ConvertPngToJpgHighQuality"));
const BatchConvertPngToJpg = lazy(() => import("@/pages/BatchConvertPngToJpg"));
const DownloadInstagramDpFullSize = lazy(() => import("@/pages/DownloadInstagramDpFullSize"));
const InstagramProfilePictureViewerOnline = lazy(() => import("@/pages/InstagramProfilePictureViewerOnline"));
const ViewPrivateInstagramProfilePicture = lazy(() => import("@/pages/ViewPrivateInstagramProfilePicture"));
const AnonymousInstagramProfilePictureDownloader = lazy(() => import("@/pages/AnonymousInstagramProfilePictureDownloader"));
const FreeInvoiceGeneratorFreelancers = lazy(() => import("@/pages/FreeInvoiceGeneratorFreelancers"));
const ProfessionalOnlineInvoiceCreator = lazy(() => import("@/pages/ProfessionalOnlineInvoiceCreator"));
const SmallBusinessInvoiceMaker = lazy(() => import("@/pages/SmallBusinessInvoiceMaker"));
const SimpleBillingGeneratorNonTechnicalUsers = lazy(() => import("@/pages/SimpleBillingGeneratorNonTechnicalUsers"));
const CombinePdfFilesOnline = lazy(() => import("@/pages/CombinePdfFilesOnline"));
const MergePdfDocumentsFree = lazy(() => import("@/pages/MergePdfDocumentsFree"));
const JoinMultiplePdfFiles = lazy(() => import("@/pages/JoinMultiplePdfFiles"));
const ProfessionalPdfBinderTool = lazy(() => import("@/pages/ProfessionalPdfBinderTool"));
const SplitPdfOnlineFree = lazy(() => import("@/pages/SplitPdfOnlineFree"));
const ExtractPagesFromPdf = lazy(() => import("@/pages/ExtractPagesFromPdf"));
const SeparatePdfPagesOnline = lazy(() => import("@/pages/SeparatePdfPagesOnline"));
const ProfessionalPdfDividerTool = lazy(() => import("@/pages/ProfessionalPdfDividerTool"));
const CompressPdfOnlineFree = lazy(() => import("@/pages/CompressPdfOnlineFree"));
const ReducePdfFileSize = lazy(() => import("@/pages/ReducePdfFileSize"));
const CompressPdfTo100kb = lazy(() => import("@/pages/CompressPdfTo100kb"));
const OptimizePdfForEmail = lazy(() => import("@/pages/OptimizePdfForEmail"));
const AddWatermarkToPdfOnline = lazy(() => import("@/pages/AddWatermarkToPdfOnline"));
const ProtectPdfWithWatermark = lazy(() => import("@/pages/ProtectPdfWithWatermark"));
const CustomPdfWatermarkCreator = lazy(() => import("@/pages/CustomPdfWatermarkCreator"));
const ProfessionalPdfWatermarkingTool = lazy(() => import("@/pages/ProfessionalPdfWatermarkingTool"));
...
const ConvertTextToPdfWithoutSignup = lazy(() => import("@/pages/tools/seo/ConvertTextToPdfWithoutSignup"));
...
const OfflinePasswordGenerator = lazy(() => import("@/pages/tools/longtail/OfflinePasswordGenerator"));
...
const QRCodeForRestaurantMenu = lazy(() => import("@/pages/tools/QRCodeForRestaurantMenu"));
const QRCodeForPropertyListings = lazy(() => import("@/pages/tools/QRCodeForPropertyListings"));
const QRCodeForProductPackaging = lazy(() => import("@/pages/tools/QRCodeForProductPackaging"));
const QRCodeForEventTickets = lazy(() => import("@/pages/tools/QRCodeForEventTickets"));
const QRCodeForInstagram = lazy(() => import("@/pages/tools/QRCodeForInstagram"));
const QRCodeForFacebook = lazy(() => import("@/pages/tools/QRCodeForFacebook"));
...
const QRCodeForSMS = lazy(() => import("@/pages/tools/QRCodeForSMS"));
...
const PrivateSignatureGenerator = lazy(() => import("@/pages/tools/longtail/PrivateSignatureGenerator"));
const BestSignatureGeneratorFree = lazy(() => import("@/pages/tools/longtail/BestSignatureGeneratorFree"));
...
const SignatureForGstInvoice = lazy(() => import("@/pages/tools/longtail/SignatureForGstInvoice"));
...
const FreeSignatureForDocuments = lazy(() => import("@/pages/tools/longtail/FreeSignatureForDocuments"));
const SignatureForTally = lazy(() => import("@/pages/tools/longtail/SignatureForTally"));
...
const SignatureGeneratorIndia = lazy(() => import("@/pages/tools/longtail/SignatureGeneratorIndia"));
...
const HowToAddSignatureInGmail = lazy(() => import("@/pages/tools/longtail/HowToAddSignatureInGmail"));
...
const ConvertVideoToAudio = lazy(() => import("@/pages/tools/longtail/ConvertVideoToAudio"));
const GetAudioFromVideo = lazy(() => import("@/pages/tools/longtail/GetAudioFromVideo"));
const VideoAudioExtractor = lazy(() => import("@/pages/tools/longtail/VideoAudioExtractor"));
const ExtractSoundFromVideo = lazy(() => import("@/pages/tools/longtail/ExtractSoundFromVideo"));
const VideoToMP3ConverterPage = lazy(() => import("@/pages/tools/longtail/VideoToMP3Converter"));
const FreeVideoToMP3Converter = lazy(() => import("@/pages/tools/longtail/FreeVideoToMP3Converter"));
const BestVideoToMP3Converter = lazy(() => import("@/pages/tools/longtail/BestVideoToMP3Converter"));
const OnlineVideoToMP3Converter = lazy(() => import("@/pages/tools/longtail/OnlineVideoToMP3Converter"));
...
const PrivateVideoToMP3Converter = lazy(() => import("@/pages/tools/longtail/PrivateVideoToMP3Converter"));
const BatchVideoToMP3Converter = lazy(() => import("@/pages/tools/longtail/BatchVideoToMP3Converter"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      ...
      <Switch>
        ...
        <Route path="/offline-password-generator" component={OfflinePasswordGenerator} />
        ...
        <Route path="/tools/qr-code-for-restaurant-menu" component={QRCodeForRestaurantMenu} />
        <Route path="/tools/qr-code-for-property-listings" component={QRCodeForPropertyListings} />
        <Route path="/tools/qr-code-for-product-packaging" component={QRCodeForProductPackaging} />
        <Route path="/tools/qr-code-for-event-tickets" component={QRCodeForEventTickets} />
        <Route path="/tools/qr-code-for-instagram" component={QRCodeForInstagram} />
        <Route path="/tools/qr-code-for-facebook" component={QRCodeForFacebook} />
        ...
        <Route path="/tools/qr-code-for-sms" component={QRCodeForSMS} />
        ...
        <Route path="/tools/private-signature-generator" component={PrivateSignatureGenerator} />
        <Route path="/tools/best-signature-generator-free" component={BestSignatureGeneratorFree} />
        ...
        <Route path="/tools/signature-for-gst-invoice" component={SignatureForGstInvoice} />
        ...
        <Route path="/tools/signature-generator-india" component={SignatureGeneratorIndia} />
        ...
        <Route path="/tools/how-to-add-signature-in-gmail" component={HowToAddSignatureInGmail} />
        ...
        <Route path="/tools/convert-text-to-pdf-without-signup" component={ConvertTextToPdfWithoutSignup} />
        ...
        <Route path="/tools/text-file-to-pdf" component={TextFileToPdf} />
        <Route path="/tools/markdown-to-pdf" component={MarkdownToPdf} />
        <Route path="/tools/text-with-images-to-pdf" component={TextWithImagesToPdf} />
        <Route path="/tools/table-to-pdf" component={TableToPdf} />
        ...
        <Route path="/tools/convert-video-to-audio" component={ConvertVideoToAudio} />
        <Route path="/tools/get-audio-from-video" component={GetAudioFromVideo} />
        <Route path="/tools/video-audio-extractor" component={VideoAudioExtractor} />
        <Route path="/tools/extract-sound-from-video" component={ExtractSoundFromVideo} />
        <Route path="/tools/video-to-mp3-converter" component={VideoToMP3ConverterPage} />
        <Route path="/tools/free-video-to-mp3-converter" component={FreeVideoToMP3Converter} />
        <Route path="/tools/best-video-to-mp3-converter" component={BestVideoToMP3Converter} />
        <Route path="/tools/online-video-to-mp3-converter" component={OnlineVideoToMP3Converter} />
        ...
        <Route path="/tools/private-video-to-mp3-converter" component={PrivateVideoToMP3Converter} />
        <Route path="/tools/batch-video-to-mp3-converter" component={BatchVideoToMP3Converter} />
