...
import {
  Download, Zap, AlertCircle, Copy, CheckCheck, Package,
  BarChart2, Check, Sparkles, ImageIcon
} from "lucide-react";
...
export default function YouTubeThumbnailTool({
  ...
  const resolvedAutoFocus = autoFocus ?? true;
    ...
    <Card className="border-2 shadow-lg overflow-hidden">
      ...
      <div className="p-6 border-b space-y-3">
        ...
        <div className="flex gap-2">
          ...
          >
            {loading
              ? <span className="flex items-center gap-2"><span className="h-4 w-4 rounded-full border-2 border-primary-foreground border-t-transparent animate-spin" />Getting…</span>
                ...
                <div className="lg:col-span-2 space-y-4 flex flex-col">
                    ...
                    <div className="space-y-2">
                      {thumbnails.map((t, i) => (
                        <button
                          ...
                          data-testid={`${testIdPrefix}-size-${t.name.toLowerCase().replace(/ /g, "-")}`}
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      data-testid={`${testIdPrefix}-btn-download-all`}
                    >
                  ...
                  <Button
                    ...
                    data-testid={`${testIdPrefix}-btn-analyze`}
                  >
